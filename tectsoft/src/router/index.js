...
const routes = [
  ...
  },
  {
    ...
    name: 'NewPackage',
    component: () => import('../components/customer/package/newPackage')
  },
  {
    path: '/customer/findCompany',
    name: 'FindCompany',
    component: () => import('../components/customer/package/findCompany')
  },
  {
    path: '/customer/company/moreInfo',
    name: 'MoreInfo',
    component: () => import('../components/customer/package/moreInfo')
  },
  {
